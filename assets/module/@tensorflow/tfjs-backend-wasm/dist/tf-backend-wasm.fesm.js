 ...
 * =============================================================================
 */
import { _FusedMatMul, broadcast_util, util, Abs, backend_util, Add, AddN, Identity, tensor, Transpose, All, Any, ArgMax, AvgPool, Reshape, BatchMatMul, slice_util, buffer, Slice, BatchToSpaceND, Cast, Ceil, ClipByValue, Concat, Conv2D, Conv2DBackpropInput, Cos, Cosh, CropAndResize, Cumprod, Cumsum, DepthToSpace, DepthwiseConv2dNative, Elu, Equal, Exp, ExpandDims, Fill, FlipLeftRight, Floor, FloorDiv, FusedBatchNorm, FusedConv2D, FusedDepthwiseConv2D, GatherNd, gather_util, GatherV2, Greater, GreaterEqual, IsNan, LeakyRelu, Less, LessEqual, Log, LogicalAnd, LogicalNot, LogicalOr, LogicalXor, Max, Maximum, MaxPool, Mean, Min, Minimum, MirrorPad, Multiply, Neg, NonMaxSuppressionV3, NonMaxSuppressionV4, NonMaxSuppressionV5, NotEqual, OneHot, OnesLike, Pack, PadV2, Pow, Prelu, Prod, Range, RealDiv, Reciprocal, Relu, Relu6, ResizeBilinear, ResizeNearestNeighbor, Reverse, RotateWithOffset, Round, Rsqrt, ScatterNd, scatter_util, Select, Sigmoid, Sin, Softmax, SpaceToBatchND, SparseFillEmptyRows, SparseReshape, SparseSegmentMean, SparseSegmentSum, SplitV, Sqrt, Square, SquaredDifference, Step, StridedSlice, StringNGrams, StringSplit, StringToHashBucketFast, Sub, Sum, Tan, Tanh, Tile, TopK, Transform, Unpack, ZerosLike, registerKernel, env, KernelBackend, DataStorage, engine, deprecationWarn, registerBackend } from '@tensorflow/tfjs-core';
...
function setupFunc$1(backend) {
    wasmFunc$7 = backend.wasm.cwrap(AddN, null /* void */, [
        'array',
        'number',
        'number',
        'number', // out_id
...
function setup$J(backend) {
    wasmFunc$6 = backend.wasm.cwrap(ArgMax, null /* void */, [
        'number',
        'number',
        'number',
        'number',
...
let wasmFunc$4;
function setup$n(backend) {
    wasmFunc$4 = backend.wasm.cwrap(NonMaxSuppressionV3, 'number', // Result*
    [
        'number',
        'number',
        'number',
...
let wasmFunc$3;
function setup$m(backend) {
    wasmFunc$3 = backend.wasm.cwrap(NonMaxSuppressionV4, 'number', // Result*
    [
        'number',
        'number',
        'number',
...
let wasmFunc$2;
function setup$l(backend) {
    wasmFunc$2 = backend.wasm.cwrap(NonMaxSuppressionV5, 'number', // Result*
    [
        'number',
        'number',
        'number',
...
let wasmFunc$1;
function setup$a(backend) {
    wasmFunc$1 = backend.wasm.cwrap(Sigmoid, null /* void */, ['number', 'number']);
}
