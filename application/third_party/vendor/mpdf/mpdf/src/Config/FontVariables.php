		...
		$this->defaults = [
			...
			'fontdata' => [
				...
				"niramit" => [
					...
					'I' => "TH Niramit AS Italic.ttf",
					'BI' => "TH Niramit AS Bold Italic.ttf",
				],
			...
			'sans_fonts' => ['dejavusanscondensed', 'sans', 'sans-serif', 'cursive', 'fantasy', 'dejavusans', 'freesans', 'liberationsans',
				...
				'humanist777', 'humanist777black', 'humanist777light', 'futura', 'hobo', 'segoeprint','thsarabun','niramit'
			],
			...
			'serif_fonts' => ['dejavuserifcondensed', 'serif', 'dejavuserif', 'freeserif', 'liberationserif',
				...
				'norasi', 'charis', 'palatino', 'constantia', 'georgia', 'albertus', 'xbzar', 'algerian', 'garamond','thsarabun','niramit'
			],
